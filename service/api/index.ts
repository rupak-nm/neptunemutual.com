...
const getContracts = async (api: (Api.Contract | Api.ContractArbitrum | Api.ContractFuji | Api.ContractBaseGoerli)): Promise<ApiResponse<ProtocolContracts>> => {
  const contracts = [Api.Contract, Api.ContractArbitrum, Api.ContractFuji, Api.ContractBaseGoerli]
