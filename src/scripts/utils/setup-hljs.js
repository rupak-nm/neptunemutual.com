const addCopyButtons = (snippets) => {
  ...
  for (let i = 0; i < numberOfSnippets; i++) {
    ...
    snippets[i].getElementsByClassName('hljs-copy')[0].addEventListener('click', function () {
      ...
      // add feedback
      this.innerHTML = '<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon"><path d="M20 6L9 17L4 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'
      const button = this
