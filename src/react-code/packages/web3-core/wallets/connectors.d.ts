 ...
 */
export declare function getConnectorByName(name: ConnectorNames, chainId: number | null): Promise<BinanceWalletConnector | BitKeepConnector | CoinbaseConnector | InjectedConnector | MetamaskConnector | SafeAppConnector | OkxConnector | null>;
