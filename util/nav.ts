    ...
    children: [
      {
        ...
        links: [
          ...
          { title: 'Documentation', href: 'https://docs.neptunemutual.com', text: 'Learn more about decentralized insurance and Neptune Mutual protocol', icon: 'file-code-01', isExternal: true },
